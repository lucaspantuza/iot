...
//NANO
#define SEN_IR A2
#define SEN_CORTINA_POTENCIOMETRO_ABAS A3
#define SEN_CORTINA_POTENCIOMETRO_ABAS_CONFIG_MIN A7
#define SEN_CORTINA_POTENCIOMETRO_ABAS_CONFIG_MAX A6
#define SEN_CORTINA_INICIO 11
#define SEN_CORTINA_MEIO 10
#define SEN_CORTINA_FIM 9
#define SEN_BLACKOUT_INICIO 8
#define SEN_BLACKOUT_MEIO 7
#define SEN_BLACKOUT_FIM 6
#define ACAO_CORTINA_ABA1 2
#define ACAO_CORTINA_ABA2 3
#define ACAO_CORTINA_COMPRIMENTO 5
#define ACAO_CORTINA_BLACKOUT 4
